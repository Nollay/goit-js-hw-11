...
var _fetchImage = require("../js/fetchImage");
...
let gallerySimpleLightbox = new (0, _simpleLightboxDefault.default)(".gallery a");
let pageNumber = 1;
let pageNr = 40;
form.addEventListener("submit", (event)=>{
    ...
    if (trimmedValue !== "") (0, _fetchImage.fetchImages)(trimmedValue, pageNumber).then((Data)=>{
        ...
        if (Data.hits.length <= 0) {
            ...
            if (Data.totalHits > 40) btnLoadMore.style.display = "block";
        }
    });
});
...
function loadMore() {
    ...
    (0, _fetchImage.fetchImages)(trimmedValue, pageNumber).then((Data)=>{
        let totalPages = Math.ceil(Data.totalHits / pageNr);
...
},{"../js/fetchImage":"gIB0J","notiflix":"5WWYd","SimpleLightbox":"4FRaW","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gIB0J":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "fetchImages", ()=>fetchImages);
const fetchImages = async (inputValue, pageNumb)=>{
    return await fetch(`https://pixabay.com/api/?key=29947512-f3d06c4dc09f4cffc6828f6d0&q=${inputValue}&orientation=horizontal&safesearch=true&image_type=photo&per_page=40&page=${pageNumb}`).then(async (response)=>{
        if (!response.ok) {
...
},{}],"4FRaW":[function(require,module,exports) {
/*!
...
},{}],"kaxSc":[function() {},{}]},["aRq6p","ebWYT"], "ebWYT", "parcelRequired7c6")
